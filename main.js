...
// For AOS animatations
AOS.init();

//To disply skills cards
let previewskl = document.querySelector('.skl-preview');
let previewboxes = document.querySelectorAll('.preview');

document.querySelectorAll('.card-container, .card').forEach(card =>{
    card.onclick = () => {
        previewskl.style.display = 'flex';
...
previewboxes.forEach(close => {
    close.querySelector('.bi-x-circle-fill').onclick = () => {
        close.classList.remove('active');
        previewskl.style.display = 'none';
    };
});
